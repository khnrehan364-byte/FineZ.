    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="glass-effect p-8 rounded-2xl border border-white/10 space-y-6">
          ...
          <div>
            <label className="block text-white font-semibold mb-2">Affiliate/Product Link *</label>
            <input
              type="url"
              required
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Use Unsplash or Imgur for free image hosting</p>
          </div>
